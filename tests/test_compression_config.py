...
class TestCompressionConfiguration(unittest.TestCase):
    ...
    def test_config_validation_invalid_target_size(self, mock_logger):
        ...
        mock_logger_instance.warning.assert_any_call("Invalid target_size_mb: 0.0. Should be between 1-100MB")
    ...
    def test_config_validation_invalid_quality_levels(self, mock_logger):
        ...
        self.assertFalse(result)
        mock_logger_instance.warning.assert_any_call("Invalid quality_levels: [60, 70, 80]. CRF values should be between 0-51")
    ...
    def test_config_validation_invalid_resolution(self, mock_logger):
        ...
        self.assertFalse(result)
        mock_logger_instance.warning.assert_any_call("Invalid max_resolution: (0, 720). Should be (width, height) with positive values")
    ...
    def test_config_validation_crf_range_error(self, mock_logger):
        ...
        self.assertFalse(result)
        mock_logger_instance.warning.assert_any_call("min_quality_crf (30) should be less than max_quality_crf (25)")
