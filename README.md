...
2. **Надішліть посилання**: Вставте будь-яке підтримуване відео URL
3. **Отримайте відео**: Отримайте відео як повідомлення для перегляду та як файл для завантаження
4. **Підтримайте нас**: Використовуйте `/donate`, якщо бот вам корисний
...
2. **Отправьте ссылку**: Вставьте любой поддерживаемый видео URL
3. **Получите видео**: Получите видео как сообщение для просмотра и как файл для загрузки
4. **Поддержите нас**: Используйте `/donate`, если бот вам полезен
